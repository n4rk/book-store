const find = (e) => {
    ...
    e.preventDefault();
    window.location.replace(`/livre/liste-livres-par-titre/${keyword.value}`);
};
...
const list = (e) => {
    ...
    e.preventDefault();
    window.location.replace(`/livre/liste-livres-date-entre/${dateMin.value}/${dateMax.value}/`);
};
